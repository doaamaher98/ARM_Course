...
#define NVIC_ISER0      *((u32*)0xE000E100) /* Enable External interrupts from 0 --> 31 	*/
#define NVIC_ISER1      *((u32*)0xE000E104) /* Enable External interrupts from 32 --> 63 */
...
#define NVIC_SCB_AIRCR	*((volatile u32*)0xE000E100 + 0x0C)
